...
exports.deleteStore = exports.updateStore = exports.getStore = exports.createStore = void 0;
...
async function createStore(req, res) {
    ...
    const registered_store = await Store_1.default.findOne({ where: { code } });
    //등록된 code가 아닌 경우
...
async function getStore(req, res) {
    ...
    //store_id를 지정하지 않아 모든 매장의 정보를 기져옴
        ...
        const stores = await Store_1.default.findAll({
            where: {
                buser_id: req.session.buser.id
            }
        });
...
async function updateStore(req, res) {
    ...
    const targetStore = await Store_1.default.findOne({
        where: {
            id: targetId,
            buser_id: req.session.buser.id
        }
